...
const sectorIcons = {
  ...
  'Peace & Order': ShieldAlert,
  'Youth & Sports': Trophy,
  'Senior Citizens & PWD': Heart,
  'Infrastructure & Education': Building2,
  'Women & Family': Users2,
} as const;

// Determine Sector Icon for Councilors
export const getSectorIcon = (sectorName?: string) => {
  return sectorIcons[sectorName as keyof typeof sectorIcons] ?? Layers;
};

// Build role-specific menu sections
export const getNavSections = (role: UserRole, sector?: string) => {
